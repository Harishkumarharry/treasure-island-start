...
if crossRoad == "left":
  ...
  swimBoat = input("You\'ve come to a lake. There is an island in the middle of the lake. Type \"wait\" to wait for a boat. Type \"swim\" to swim across. \n")
  ...
  print("Please choose correct crossroad. Game Over.")